''' Taken from https://github.com/hendrycks/robustness/blob/master/ImageNet-C/create_c/make_cifar_c.py '''
...
def asset_path(image_base):
    return os.path.join(os.path.dirname(__file__), image_base)

def frost(x, severity=1):
    c = [(1, 0.2), (1, 0.3), (0.9, 0.4), (0.85, 0.4), (0.75, 0.45)][severity - 1]
    idx = np.random.randint(5)
    filename = [asset_path('frost1.png'), asset_path('frost2.png'), asset_path('frost3.png'), asset_path('frost4.jpg'), asset_path('frost5.jpg'), asset_path('frost6.jpg')][idx]
