...
from text_aug_utils import generate_text_aug_dict, generate_text_matching_target_dict

def generate_aug_dict():
    image_aug_dict = generate_image_aug_dict()
    text_aug_dict = generate_text_aug_dict()
    text_matching_target_dict = generate_text_matching_target_dict()
    ...
    for augID in sorted(image_aug_dict.keys()):
        ...
        aug_dict[augID]['text_matching_targets'] = text_matching_target_dict[augID]
