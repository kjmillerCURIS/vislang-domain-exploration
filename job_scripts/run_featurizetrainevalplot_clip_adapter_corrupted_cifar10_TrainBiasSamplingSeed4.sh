...
#$ -l gpu_c=5.0
#$ -l h_rt=1:59:59
#$ -N featurizetrainevalplot_clip_adapter_corrupted_cifar10_TrainBiasSamplingSeed4
#$ -j y
#$ -m ea
...
python make_corrupted_cifar10_plots.py ../vislang-domain-exploration-data/ToyExperiments/experiment_CorruptedCIFAR10BaselineParamsLR5_TrainBiasSamplingSeed4 ../vislang-domain-exploration-data/ToyExperiments/plots/trainimagebiassamplingrep_separateplots/plot_CorruptedCIFAR10BaselineParamsLR5_TrainBiasSamplingSeed4.png
