...
#$ -l gpu_c=5.0
#$ -l h_rt=0:29:59
#$ -N evalplot_corrupted_cifar10_domainpred
#$ -j y
#$ -m ea
...
python make_corrupted_cifar10_plots.py ../vislang-domain-exploration-data/ToyExperiments/experiment_CorruptedCIFAR10BaselineParamsLR5 ../vislang-domain-exploration-data/ToyExperiments/plots/initial_experiment_plots/plot_CorruptedCIFAR10BaselineParamsLR5_DomainPred.png 1
