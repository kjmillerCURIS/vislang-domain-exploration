...
#$ -l gpu_c=5.0
#$ -l h_rt=1:59:59
#$ -N trainevalplot_clip_adapter_corrupted_cifar10_BatchSize64_DomainlessTextProp25_UnbiasedTrain
#$ -j y
#$ -m ea
...
python make_corrupted_cifar10_plots.py ../vislang-domain-exploration-data/ToyExperiments/experiment_CorruptedCIFAR10BaselineParamsLR5BatchSize64DomainlessTextProp25_UnbiasedTrain ../vislang-domain-exploration-data/ToyExperiments/plots/BatchSize64_plots/plot_CorruptedCIFAR10BaselineParamsLR5BatchSize64DomainlessTextProp25_UnbiasedTrain.png 0
python make_corrupted_cifar10_plots.py ../vislang-domain-exploration-data/ToyExperiments/experiment_CorruptedCIFAR10BaselineParamsLR5BatchSize64DomainlessTextProp25_UnbiasedTrain ../vislang-domain-exploration-data/ToyExperiments/plots/BatchSize64_plots/plot_CorruptedCIFAR10BaselineParamsLR5BatchSize64DomainlessTextProp25_UnbiasedTrain_DomainPred.png 1
