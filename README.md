...
* Take a look at `sample_from_laion.py`, which picks the top-K LAION image-text pairs by log-prob of each domain. I've set K to 140,000 per domain. This will make the "laion_sample" folder inside of the experiment_dir, and leave various .txt and .pkl files telling the image-bases and URLs and captions.  
